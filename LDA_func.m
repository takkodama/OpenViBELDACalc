...
function [W, Score, P] = LDA_func(Input, Label, Priors)
...
% Calcurate discriminant scores
Score = [ones(length(Input(:,1)),1) Input] * W';

% Calculate class probabilities
P = exp(Score) ./ repmat(sum(exp(Score),2),[1 2]);
